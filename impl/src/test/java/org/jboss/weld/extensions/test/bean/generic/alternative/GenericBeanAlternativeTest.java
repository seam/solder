 ...
 */
package org.jboss.weld.extensions.test.bean.generic.alternative;
...
import org.jboss.weld.extensions.test.util.MavenArtifactResolver;
...
public class GenericBeanAlternativeTest
{
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war").addLibrary(MavenArtifactResolver.resolve("org.jboss.weld", "weld-extensions"));
      archive.addPackage(GenericBeanAlternativeTest.class.getPackage());
      archive.addWebResource("org/jboss/weld/extensions/test/bean/generic/alternative/beans.xml", "beans.xml");
      return archive;
   }
